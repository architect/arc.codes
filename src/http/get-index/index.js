...
let alias = {
  ...
  '/guides/local-dev':                 '/guides/local-dev.md',
  '/guides/share-code':                '/guides/share-code.md',
  '/guides/sessions':                  '/guides/sessions.md',
  '/guides/middleware':                '/guides/middleware.md',
  '/guides/deps':                      '/guides/deps.md',
  '/guides/logs':                      '/guides/logs.md',
  '/guides/dns':                       '/guides/dns.md',
  '/guides/iam':                       '/guides/iam.md',
  '/guides/multiple-aws-accounts':     '/guides/multiple-aws-accounts.md',
  '/guides/yaml-and-json':             '/guides/yaml-and-json.md',
